...
function MessageSubmit()
{
	...
	var message  = content.message.value;
	if(user=="null")
	{
		alert("请先登录。");
	}
	...
	{
		window.location.href = "leaveMessage.jsp?user=" + user + "&num=" + num + "&time=" + time + "&message=" + message;
	}
}
</script>
<style type="text/css">
	...
	%>
    	...
    	<tr>
        	...
        	<tr>
          		...
          		<form name="comment"><%out.print(rs.getString(3)); %>&nbsp;</form></td>
        	</tr></table>
        	</td>
    	</tr>
  		</table>
  		<br>
	<%
		String selectSQL1 = "Select * From Message Where num = '" + num + "'Order By time DESC";
		ResultSet rs1 = db.executeQuery(selectSQL1);
	    while(rs1.next())
		{
	%>
		评论<br>
  		<table width="700" height="100" border="0" style="margin-top:1px;border:1px solid #000000;table-layout:fixed;"cellpadding="0"cellspacing="0">
    	<tr>
      		<td width="100"><%out.print(rs1.getString(2));%></td>
      		<td width="605"><table width="603" height="94" border="0" style="margin-top:0px;border:1px solid #000000;table-layout:fixed;"cellpadding="0"cellspacing="0">
        	<tr>
          		<td class="AutoNewline"><p style="margin-top:0px;">&nbsp;&nbsp;<%out.print(rs1.getString(4));%></p></td>
        	</tr>
        	<tr>
          		<td height="20" align="right">
          		<form name="comment"><%out.print(rs1.getString(3)); %>&nbsp;
          		</form></td>
        	</tr></table>
        	</td>
    	</tr>
...
<div id="apDiv3">
  <table width="158" height="50" border="1">
    ...
    <input type="button" value="评论" onclick="ShopConfirm('img1')" style="background-color:transparent;border:0;font-size:16px;font-style:italic;text-decoration:underline"/>
    </td>
    </tr>
  </table>
  <table width="158" height="50" border="1">
...
<div id="img1" style="position: absolute; top: 200px; left: 400px; background: #FFF; font-size: 14px; z-index: 900; border: 2px #FFCC00 solid; width: 350px; height: 180px; padding: 9px;"> 
  ...
  <div id="apDiv8" style="position: absolute;width: 347px;height: 21px;z-index: 901;left: 12px;top: 170px;">
      <input type="button" name="submit" onclick="MessageSubmit()"value="评论" />
  </div>
  </div>
