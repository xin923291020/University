...
<body>
  ...
  %>
	<div id="loading">
		<img src="images/wait.gif" alt="Loading..."></img>
	</div>
	<div class="header">
		<div id="logo">
			<img src="images/movielogo_gray_index2.PNG" alt="Logo"></img>
		</div>
	...
	<div id="main">
		<div class="wbox dark">
			<div id="basedMood">
				<div class="titbar">
					<div class="tit">
						Movies based on Mood <input type="button"
							value="Get Similar Mood Movies" id="getMoviesMood">
					</div>
				</div>
				<div class="slidebox" id="slideboxMood"></div>
			</div>
		</div>
		<div id="firstPart">
			<%
			...
			<div class="wbox dark">
				<div id="continueWatching">
					...
					<div class="slidebox">
						...
						<a id="prevSlideCW" class="arrow lef"><span></span></a> <a
							id="nextSlideCW" class="arrow rig"><span></span></a>
						<% } %>
						<div class="box">
							<div class="in jspScrollable"
								style="overflow: hidden; padding: 0px; width: 782px; outline: none; height: 230px;">
								<div class="jspContainer" style="width: 782px; height: 230px;">
									<div class="rightpane"></div>
									<div class="leftpane"></div>
									<div class="jspPane"
										style="padding: 0px; width: 782px; left: 0px;">
										<div class="boxes">
                    ...
                    for (int i =0; i < movieTOList1.size(); i++){
                        ...
                        %>
												<li style="height: 240px;"
													class="item-box jcarousel-item-<%= i %>"
													movieid="<%= movieTO.getId() %>"
													rel="movieInformation.jsp?id=<%= movieTO.getId() %>">
													<a href="#"> <span class="img loaded"> <% if (movieTO.getPosterPath().equalsIgnoreCase("") || !useMoviePosters) { %>
															<div class=""
																style="height: 184px; overflow: hidden; position: relative;"
																title="<%= movieTO.getTitle() %>">
																<img src="images/genericfilm.png" name="genericfilm.png"
																	align="display: block; " class="reflected">
													...
													<span class="tit2"><%= movieTO.getTitle() %></span> <%
                      ...
                      %>
														<div class="meter" yt="<%=youtubeKey%>">
															<span style="width: <%=actual%>%"></span>
														</div>
												</a>
												</li>
												<% } %>
    ...
    %>
			<div class="wbox dark">
				<div id="continueWatching">
					...
					<div class="slidebox">
						<% if(movieTOList1.size() > 5) { %>
						<a id="prevSlideRW" class="arrow lef"><span></span></a> <a
							id="nextSlideRW" class="arrow rig"><span></span></a>
						<% } %>
						<div class="box">
							<div class="in jspScrollable"
								style="overflow: hidden; padding: 0px; width: 782px; outline: none;">
                    ...
                    for (int i =0; i < movieTOList1.size(); i++){
                        MovieTO movieTO = movieTOList1.get(i);
                        %>
												<li class="item-box jcarousel-item-<%= i %>"
													rel="movieInformation.jsp?id=<%= movieTO.getId() %>">
													<a href="#"> <span class="img loaded"> <% if (movieTO.getPosterPath().equalsIgnoreCase("") || !useMoviePosters) { %>
															<div class=""
																style="height: 184px; overflow: hidden; position: relative;"
													...
													<span class="tit2"><%= movieTO.getTitle() %></span><br>
												</a>
												</li>
												<% } %>
											</ul>
			...
			<div id="category<%= categoryId %>_row">
				...
				<div class="slidebox">
						...
						<div class="in jspScrollable"
							...
							<div class="jspContainer" style="width: 782px; height: 216px;">
								...
								<div class="jspPane"
									style="padding: 0px; width: 782px; left: 0px;">
									<div class="boxes">
										<ul id="mycarousel<%= categoryId %>"
											class="jcarousel-skin-name">
											<%
                    ...
                    for (int i =0; i < movieTOListEXT.size(); i++){
                        ...
                        %>
											<li class="item-box jcarousel-item-<%= i %>"
												rel="movieInformation.jsp?id=<%= movieTO.getId() %>&catid=<%= categoryId %>">
												<a href="#"> <span class="img loaded"> <% if (movieTO.getPosterPath().equalsIgnoreCase("") || !useMoviePosters) { %>
														<div class=""
															style="height: 184px; overflow: hidden; position: relative;"
															title="<%= movieTO.getTitle() %>">
    ...
    %>
			<div class="wbox dark">
				<div id="continueWatching">
					...
					<div class="slidebox">
						<% if(movieTOList1.size() > 5) { %>
						<a id="prevSlideCP" class="arrow lef"><span></span></a> <a
							id="nextSlideCP" class="arrow rig"><span></span></a>
						<% } %>
						<div class="box">
							<div class="in jspScrollable"
								style="overflow: hidden; padding: 0px; width: 782px; outline: none;">
    ...
    %>
			<div class="wbox dark">
				<div id="continueWatching">
					...
					<div class="slidebox">
						<% if(movieTOList1.size() > 5) { %>
						<a id="prevSlidePW" class="arrow lef"><span></span></a> <a
							id="nextSlidePW" class="arrow rig"><span></span></a>
						<% } %>
						<div class="box">
							<div class="in jspScrollable"
								style="overflow: hidden; padding: 0px; width: 782px; outline: none; height: 230px;">
                    ...
                    for (int i =0; i < movieTOList1.size(); i++){
                        ...
                        %>
												<li style="height: 240px;"
													class="item-box jcarousel-item-<%= i %>"
													rel="movieInformation.jsp?id=<%= movieTO.getId() %>">
													<a href="popup"> <span class="img loaded"> <% if (movieTO.getPosterPath().equalsIgnoreCase("") || !useMoviePosters) { %>
															<div class=""
																style="height: 184px; overflow: hidden; position: relative;"
																title="<%= movieTO.getTitle() %>">
																<img src="images/genericfilm.png" name="genericfilm.png"
                    ...
                    %> <input name="star-pw<%=i%>" type="radio"
													class="star-pw<%=i%> star required" value="1"
													<% if (avg > 0 && avg <= 1.5 ) out.print("checked='checked'"); %> />
													<input name="star-pw<%=i%>" type="radio"
													class="star-pw<%=i%> star" value="2"
													<% if (avg > 1.5 && avg <= 2.5 ) out.print("checked='checked'"); %> />
													<input name="star-pw<%=i%>" type="radio"
													class="star-pw<%=i%> star" value="3"
													<% if (avg > 2.5 && avg <= 3.5 ) out.print("checked='checked'"); %> />
													<input name="star-pw<%=i%>" type="radio"
													class="star-pw<%=i%> star" value="4"
													<% if (avg > 3.5 && avg <= 4.5 ) out.print("checked='checked'"); %> />
													<input name="star-pw<%=i%>" type="radio"
													class="star-pw<%=i%> star" value="5"
													<% if (avg > 4.5) out.print("checked='checked'"); %> /> <script
														type="text/javascript">setRating(<%=rated%>,"star-pw<%=i%>",<%=movieTO.getId()%>);</script>
	...
	<div class="footer" style="color: #333; text-align: center;">We
		would like to thank Wikipedia for sharing the movie information data
		and TMDb for sharing the movie poster URLs. Movie images provided by
