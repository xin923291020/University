...
public class CustomerTO extends BaseTO implements Comparable<CustomerTO>
{
	 ...
	 * 
	 * @param objectNode
	 *            - JSON representation of CustomerTO
	 */
	 ...
	 * <p>
	 * This method construct a JSON object from the CustomerTO and then uses
	 * JSONObject.toString() method to convert the object into string text.
	 *
	 ...
	 * 
	 * @param objectNode
	 *            which is JSON object consisting param=values
	 */
	 ...
	 * object of same type. Score attribute is used to compare two objects and
	 * ranked in dessending order.
	 * 
	 * @param custTO
	 *            - Other CustomerTO object that this object will be compared
	 *            with
	 * @return int
	 */
