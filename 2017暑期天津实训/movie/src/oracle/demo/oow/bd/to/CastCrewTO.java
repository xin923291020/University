...
public class CastCrewTO extends BaseTO
{
	...
	public void setJsonObject(ObjectNode castCrewNode)
	{
		...
		Iterator<JsonNode> casts = castCrewNode.get(JsonConstant.CAST).iterator();
		Iterator<JsonNode> crews = castCrewNode.get(JsonConstant.CREW).iterator();
	...
	public static void main(String[] args)
	{
		...
		jsonTxt = "{\"id\":857,\"cast\":[{\"id\":558298,\"name\":\"Tom Hanks\",\"order\":1,\"character\":\"Capt. John H. Miller\"}],\"crew\":[]}";
